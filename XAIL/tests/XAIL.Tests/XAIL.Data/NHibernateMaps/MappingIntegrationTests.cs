...
using XAIL.Data.NHibernateMaps;
...
namespace Tests.XAIL.Data.NHibernateMaps
{
    /// <summary>
    ...
    public class MappingIntegrationTests
    {
        ...
        public virtual void SetUp()
        {
            ...
            configuration = NHibernateSession.Init(new SimpleSessionStorage(), mappingAssemblies,
                                   ...
                                   "../../../../app/XAIL.Web/NHibernate.config");
        }
        ...
        /// <summary>
        /// This test actually run against sql db. So update the scheme first before running this test.
        /// </summary>
